...
-- COMITE_MENSAJES TABLE --
CREATE TABLE IF NOT EXISTS Comite_Mensajes (
    id_mensaje SERIAL PRIMARY KEY,
    comite_id INT NOT NULL,
    socio_id INT NOT NULL,
    mensaje TEXT NOT NULL,
    fecha_envio TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT FK_MENSAJE_COMITE FOREIGN KEY (comite_id) REFERENCES Comite (id_comite) ON DELETE CASCADE,
    CONSTRAINT FK_MENSAJE_SOCIO FOREIGN KEY (socio_id) REFERENCES Socio (id_socio) ON DELETE CASCADE
);
...
INSERT INTO
    Tipo_Socio (nombre_tipo, descripcion, cuota, price_stripe)
VALUES
    (
        'Socio',
        'Miembro asociado a la plataforma.',
        20.0,
        'price_1RaGzAPbMwKwBYLWadUDiRZT'
    ),
    (
        'Estudiante',
        'Miembro que se encuentra en formación académica.',
        10.0,
        'price_1RaHU2PbMwKwBYLWo0AaCRmB'
    ),
    (
        'Profesional',
        'Miembro con experiencia y/o titulación profesional.',
        50.0,
        'price_1RaaIcPbMwKwBYLW145DYXpp'
    ),
    (
        'Honorario',
        'Miembro que contribuye de manera honorífica a la plataforma.',
        0.0,
        'price_1RaaKePbMwKwBYLWPAhqnahb'
    ),
    (
        'Internacional',
        'Miembro con lenguaje extranjero.',
        100.0,
        'price_1RaHVqPbMwKwBYLWK7Uqmj3J'
    ),
    (
        'Corporación',
        'Asociación corporativa.',
        500.0,
        'price_1RaHVDPbMwKwBYLWrXVYmm7F'
    );
...
VALUES
    (
        ...
        'admin',
        'admin@admin.com',
        '$2a$12$jb4zKaou5JP7lBA5F1.JC.TDDi1.mGxC164/HETc5WNtWnmozxM3y',
        '123456789',
        '2001-11-03 00:00:00',
        '2025-05-10 15:37:21.561',
        '3000-05-10 15:37:21.561',
        1,
        1
    ),
    (
...
-- Comités
INSERT INTO
    Comite (nombre_comite, descripcion, fecha_creacion)
VALUES
    (
        'Comité de Inteligencia Artificial',
        'Encargado de regular y promover investigaciones en IA.',
        CURRENT_TIMESTAMP
    ),
    (
        'Comité de Ciberseguridad',
        'Fomenta buenas prácticas y políticas de seguridad informática.',
        CURRENT_TIMESTAMP
    ),
    (
        'Comité de Ingeniería de Software',
        'Dedicado al estudio y mejora de metodologías ágiles y arquitecturas.',
        CURRENT_TIMESTAMP
    ),
    (
        'Comité de Divulgación',
        'Responsable de la organización de charlas, congresos y artículos públicos.',
        CURRENT_TIMESTAMP
    ) ON CONFLICT DO NOTHING;

-- Miembros Comité (Usando subconsultas por email para evitar errores de ID)
INSERT INTO
    Miembros_Comite (fecha_registro, socio, comite, rol_comite)
VALUES
    (
        CURRENT_TIMESTAMP,
        (
        ...
        (
            ...
            FROM
                Comite
            WHERE
                nombre_comite = 'Comité de Inteligencia Artificial'
        ),
        6
    ),
    (
    ...
    (
        ...
        (
            ...
            FROM
                Comite
            WHERE
                nombre_comite = 'Comité de Ingeniería de Software'
        ),
        6
    ),
    (
...
VALUES
    (
        'Detección de sesgos en LLMs',
        'Proyecto para analizar y reducir discriminación en modelos masivos del lenguaje.',
        '2025-01-01',
        '2026-01-01',
        'activo',
        'deteccion-de-sesgos-en-llms'
    ),
    (
        'Seguridad en redes IoT',
        'Estudio sobre vulnerabilidades modernas en dispositivos inteligentes domésticos.',
        '2024-06-01',
        '2025-06-01',
        'activo',
        'seguridad-en-redes-iot'
    ...
    (
        'Nuevo framewok Frontend',
        'Investigación comparativa de rendimiento entre React, Vue y Svelte.',
        '2023-01-01',
        '2024-01-01',
        'finalizado',
    ...
    (
        'Machine Learning aplicado a la sanidad',
        'Análisis predictivo de enfermedades usando historiales médicos.',
        '2025-03-01',
        '2027-03-01',
        'activo',
        'machine-learning-aplicado-a-la-sanidad'
...
-- Miembros Proyecto
INSERT INTO
    Socio_Proyecto (fecha_registro, socio, proyecto, rol_proyecto)
VALUES
    (
        CURRENT_TIMESTAMP,
        (
    ...
    (
        ...
        (
            ...
            FROM
                Proyectos_Investigacion
            WHERE
                nombre_proyecto = 'Seguridad en redes IoT'
        ),
        7
    ),
    (
        ...
        (
            ...
            FROM
                Proyectos_Investigacion
            WHERE
                nombre_proyecto = 'Nuevo framewok Frontend'
        ),
        7
    ),
    (
...
-- Publicaciones
INSERT INTO
    Publicaciones (titulo, contenido, fecha_publicacion, socio, slug)
VALUES
    (
        'Avances en algoritmos cuánticos',
        'El futuro de la computación está marcado por los bits cuánticos y su estabilización mediante nuevas estructuras.',
        CURRENT_TIMESTAMP,
        (
            SELECT
                id_socio
        ...
        'avances-en-algoritmos-cuanticos'
    ),
    (
        '10 principios de seguridad sólida',
        'Exploramos cómo evitar ataques de inyección y XSS en aplicaciones modernas mediante el uso de interceptores.',
        CURRENT_TIMESTAMP,
        (
            SELECT
                id_socio
        ...
        '10-principios-de-seguridad-solida'
    ),
    (
        'Impacto de IA generativa en la educación',
        'La adaptación de los métodos de enseñanza ha sufrido cambios drásticos que requieren atención continua del profesorado.',
        CURRENT_TIMESTAMP,
        (
            SELECT
                id_socio
        ...
        'impacto-de-ia-generativa-en-la-educacion'
    ),
    (
        'Eficiencia energética en centros de datos',
        'Cómo optimizar el código desde el backend y usar edge computing para reducir emisiones de huella de carbono a gran escala.',
        CURRENT_TIMESTAMP,
        (
            SELECT
                id_socio
        ...
        'eficiencia-energetica-en-centros-de-datos'
    );
...
VALUES
    (
        'Muy interesante el artículo, excelente aportación.',
        (
            SELECT
                id_socio
            FROM
    ...
    (
        'Deberías incluir más referencias sobre RSA.',
        (
            SELECT
                id_socio
            FROM
        ...
        (
            ...
            FROM
                Publicaciones
            WHERE
                titulo = '10 principios de seguridad sólida'
        ),
        CURRENT_TIMESTAMP,
        true
    ),
    (
        'Totalmente de acuerdo, la docencia debe evolucionar rápidamente.',
        (
            SELECT
                id_socio
            FROM
        ...
        (
            ...
            FROM
                Publicaciones
            WHERE
                titulo = 'Impacto de IA generativa en la educación'
        ),
        CURRENT_TIMESTAMP,
        true
    );
...
VALUES
    (
        'Congreso Nacional de IA 2026',
        '2026-09-10 09:00:00',
        '2026-09-12 18:00:00',
        'El mayor evento de Inteligencia Artificial de España, reuniendo a cientos de expertos en deep learning y LLMs.',
        50.00,
        (
            SELECT
                id_direccion
    ...
    (
        'Hackathon de Seguridad y Redes',
        '2026-11-20 10:00:00',
        '2026-11-22 20:00:00',
        'Competición de hacking ético de 48 horas intensivas organizadas por equipos de Red y Blue team.',
        20.00,
        (
            SELECT
                id_direccion
    ...
    (
        'Charla: Arquitectura Limpia en Node',
        '2025-12-15 17:00:00',
        '2025-12-15 19:00:00',
        'Charla sobre diseño de software orientado al dominio y a buenas prácticas estructurales en aplicaciones monolíticas.',
        0.00,
        (
            SELECT
                id_direccion
...
INSERT INTO
    Inscripciones (estado_inscripcion, evento, socio)
VALUES
    (
        'pagado',
        (
    ...
    (
        ...
        (
            ...
            FROM
                Evento
            WHERE
                nombre_evento = 'Hackathon de Seguridad y Redes'
        ),
        (
            SELECT
                id_socio
